...
export const projectsData = [
  ...
  },
  {
    ...
    description: "AWS cloud solution using VPCs, subnets, EBS, CloudTrail, and EC2 instances with automated failover.",
    date: "2023-12-05",
    demoLink: "https://github.com/kushaljetty",
  },
  {
...
export const BtnList = [
  ...
  {
    label: "X",
    link: "https://x.com/KushalJetty_007",
    icon: "twitter",
    newTab: true,
  },
  {
    label: "Resume",
    link: "/Kushal_Jetty_v3.pdf",
    icon: "resume",
    newTab: true,
  },
];
